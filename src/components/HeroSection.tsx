...
//import { RevealImage } from "./ui/reveal-image";
...
export default function HeroSection() {
  ...
  return (
    <ParticlesBackground intensity="medium" colorMode="auto">
      ...
      <section id="home" className="py-40 relative overflow-hidden bg-[hsl(var(--hero-bg))]">
                    ...
                    <div className="w-full h-full rounded-full bg-background p-2">
                      <div className="relative w-full h-full rounded-full overflow-hidden">
                        <Image
                          ...
                          //unoptimized // ✅ Original quality, no compression
                          quality={100} // 100% quality
                          sizes="100vw" // Full width of viewport
                          onError={(e) => {
...
//                 <RevealImage
//                   src="https://ext.same-assets.com/64fe5d1eb1ced2fa42e9d92c/64fe651a65ddfcc0373c8f6d_undraw_data_processing_yrrv.svg"
//                   alt="Data Analytics Engineer Illustration"
//                   fill
//                   priority
//                 />
//               </div> */}
